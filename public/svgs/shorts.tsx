export const ShortsSvg = () =><svg
            viewBox="427.0352 123.5503 191.5458 252.8994"
            className="h-5 w-5"
          ...
          >
            <g
              ...
              transform="matrix(2.8099999427795415, 0, 0, 2.8099999427795415, 396.3750669416049, 123.54968445822125)"
            >
              <path
              ...
              />
              <path
                d="M 36.741 59.95 C 36.396 59.95 36.051 59.861 35.742 59.682 C 35.122 59.325 34.74 58.664 34.74 57.949 L 34.74 32.417 C 34.74 31.702 35.121 31.042 35.74 30.685 C 36.359 30.328 37.122 30.328 37.74 30.685 L 59.825 43.422 C 60.444 43.779 60.825 44.438 60.826 45.153 C 60.827 45.868 60.446 46.527 59.829 46.886 L 37.744 59.681 C 37.433 59.861 37.087 59.95 36.741 59.95 Z M 59.823 45.367 L 38.741 54.48 L 54.829 45.159 L 59.823 45.367 Z"
                style={{
                  stroke: "none",
                  strokeWidth: 1,
                  strokeDasharray: "none",
